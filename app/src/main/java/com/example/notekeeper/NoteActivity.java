...
//        mNote = DataManager.getInstance().getNotes().get(mNoteId); // WE ARE GETTING THE NOTE FROM DB NOW BABY :P
    }
    ...
    private void deleteNoteFromDatabase() {
        ...
        executor.execute(() -> {
            //Background work here
            SQLiteDatabase db = mDbOpenHelper.getWritableDatabase();
            db.delete(NoteInfoEntry.TABLE_NAME, selection, selectArgs);
    ...
    private void saveNoteToDataBase(String courseId, String noteTitle, String noteText) {
        ...
        SQLiteDatabase db = mDbOpenHelper.getWritableDatabase();
        db.update(NoteInfoEntry.TABLE_NAME, values, selection, selectionArgs); // no return  because we new that we will only update one row.
