...
// singleton which mean there is a one instance of this class in the entire project
...
//            ourInstance.initializeExampleNotes();
    ...
    @SuppressLint("Recycle") // I have no Idea of what this can do.
    ...
    public int createNewNote(CourseInfo course, String noteTitle, String noteText) {
        ...
        return index; // -1 not a valid index in our application
    }
    //endregion
